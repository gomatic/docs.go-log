# `docs.go-log` — public documentation repository

This is the **public** documentation site for [`gomatic/go-log`](https://github.com/gomatic/go-log), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-log`](https://github.com/gomatic/go-log)'s API changes, update [`content/`](../content/) to match.
